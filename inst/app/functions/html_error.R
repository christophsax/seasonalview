...
#     title <- paste("<h5 class='alert-title'>", gsub("\\n", "", title), "</h5>")
...
#       paste0("<p id = 'alert-content' class='alert-message'><strong>", x[1], "</strong>", "<ul>", paste(paste("<li>", x[-1], "</li>"), collapse = " "), "</ul></p>")
#     }
